...
<h2><?=$arResult["NAME"]?></h2>
<div style="text-align: center;">
  <a href="<?=$arResult["DETAIL_PAGE_URL"]?>zakaz/" > ”œ»“‹ ¡»À≈“€ </a>
</div>
...
?>
		...
		<img border="0" src="<?=$img["src"];?>"  alt="—ıÂÏ‡ Á‡Î‡" title="—ıÂÏ‡ Á‡Î‡" />
	<?endif?>
	</div>
	...
	<?if(is_array($arResult["DETAIL_PICTURE"])):?>
		<img border="0" src="<?=$arResult["DETAIL_PICTURE"]["SRC"]?>" width="<?=$arResult["DETAIL_PICTURE"]["WIDTH"]?>" height="<?=$arResult["DETAIL_PICTURE"]["HEIGHT"]?>" alt="—ıÂÏ‡ Á‡Î‡" title="—ıÂÏ‡ Á‡Î‡" />
