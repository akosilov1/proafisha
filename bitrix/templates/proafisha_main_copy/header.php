	...
	<tbody>
		...
		<td class="head-top-search text-center">
			<div class="search-form">
				<form action="/search/">
					<input type="text" name="q" value="" size="40" maxlength="100" placeholder="Поиск" /><input name="s" type="submit" value="Найти" />
				</form>
			</div>
		</td>
		<td class="head-top-tel" width="380">
			<span>Режим работы с 09:00 до 22:00&nbsp;&nbsp;&nbsp;&nbsp;</span>
  ...
  <tbody> 
    <tr valign="top"> 	 	 	
    	<?if(NOT_SHOW_LEFT_COLUMN!="Y"):?>
			...
			<br /><br /><br />
			<b><a href="http://www.proafisha.ru" style="color:#448b3b;" >ТЕАТРЫ МОСКВЫ ЛУЧШЕЕ</a></b> 
	       <br />
	...
	array(
		"ACTIVE_COMPONENT" => "Y"
         ...
         <!--<div align="center"><b>календарь событий:</b></div>
...
<!-- Третья колонка OPEN -->
  <?/*table cellspacing="0" cellpadding="0" border="0" width="100%"> 
          <tbody> 
            <tr><td bgcolor="#fff"> 
                <p></p>
               <center> Где посмотреть театральную афишу? Куда пойти в Москве? Информация  по тел. +7 (499) 504 98 22 Наше агентство предлагает услуги заказа билетов, Вашему вниманию предлагается информация про афишу и репертуар, расписание событий Москвы: широкий Выбор и предложений культурно массовых мероприятий. Заказ и доставка билетов на спектакли, концерты, цирковые предоставление и шоу Москвы. Билеты на ресурсе про афиша с доставкой по Москве в удобное для Вас время. Режим работы с 10:00 до 20:00 онлайн круглосуточно. </center> 
                <div align="center"><span style="color: #9d0a0f;">ПРОДАЖА БИЛЕТОВ НА ВСЕ СОБЫТИЯ МОСКВА НА ВЫБОР ОФИЦИАЛЬНЫЕ БИЛЕТЫ ТЕАТРАЛЬНЫЙ СЕЗОН 2017 ГОД БИЛЕТЫ В НАЛИЧИИ НА САЙТЕ</span><p></p>
               </td></tr>
           </tbody>
         </table>
